...
{
    /// <summary>
    /// GridPattern縺ｮ蜊倅ｽ薙ユ繧ｹ繝・    /// Microsoft莉墓ｧ倥↓蝓ｺ縺･縺・◆GridPattern縺ｮ讖溯・繧偵Δ繝・け繝吶・繧ｹ縺ｧ繝・せ繝医＠縺ｾ縺・    /// </summary>
    ...
    public class GridPatternTests : IDisposable
    {
        ...
        #region Microsoft莉墓ｧ俶ｺ匁侠縺ｮGridPattern蠢・医・繝ｭ繝代ユ繧｣繝・せ繝・
        ...
        */
        ...
        {
            // Arrange - Microsoft莉墓ｧ・ 蜊倅ｸ繧｢繧､繝・Β縺ｧ繧ゅげ繝ｪ繝・ラ縺ｨ縺励※譛牙柑
            var expectedResult = new ServerEnhancedResponse<GridInfoResult>
            {
                Success = true,
                Data = new GridInfoResult
        ...
        */
        ...
        #region Microsoft莉墓ｧ俶ｺ匁侠縺ｮGetItem繝｡繧ｽ繝・ラ繝・せ繝・
        [Theory]
        [InlineData(0, 0)]
        [InlineData(2, 1)]
        [InlineData(4, 2)]
        ...
        {
            // Arrange - Microsoft莉墓ｧ・ 繧ｰ繝ｪ繝・ラ蠎ｧ讓吶・0繝吶・繧ｹ
            var expectedResult = new ServerEnhancedResponse<ElementSearchResult>
            {
                Success = true,
                Data = new ElementSearchResult
        ...
        {
            // Arrange - Microsoft莉墓ｧ・ 遨ｺ縺ｮ繧ｻ繝ｫ縺ｧ繧６I Automation隕∫ｴ繧定ｿ斐☆蠢・ｦ√′縺ゅｋ
            var expectedResult = new ServerEnhancedResponse<ElementSearchResult>
            {
                Success = true,
                Data = new ElementSearchResult
        ...
        #region Microsoft莉墓ｧ俶ｺ匁侠縺ｮArgumentOutOfRangeException 繝・せ繝・
        [Theory]
        [InlineData(-1, 0)]
        [InlineData(0, -1)]
        [InlineData(-1, -1)]
        ...
        */
        ...
        {
            // Arrange - 蠅・阜蛟､縺ｧ縺ｮ豁｣蟶ｸ蜍穂ｽ懊ユ繧ｹ繝・            var expectedResult = new ServerEnhancedResponse<ElementSearchResult>
            {
                Success = true,
                Data = new ElementSearchResult
                {
