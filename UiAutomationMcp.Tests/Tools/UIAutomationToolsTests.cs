...
namespace UIAutomationMCP.Tests.Tools
{
    ...
    public class UIAutomationToolsTests : IDisposable
    {
        ...
        public async Task SearchElements_WithSearchText_Success()
        {
            ...
            {
                new ElementInfo { TargetAutomationId = "btn1", Name = "Button1", ControlType = "Button" },
                new ElementInfo { TargetAutomationId = "btn2", Name = "Button2", ControlType = "Button" }
            };
        ...
        public async Task IsElementReadOnly_Success_ReturnsReadOnlyStatus()
        {
            ...
            _mockValueService.Setup(s => s.IsReadOnlyAsync("textBox", "TestWindow", null, null, 30))
                                 .Returns(Task.FromResult(serverResponse));
        ...
        public async Task IsElementReadOnly_ElementNotFound_ReturnsError()
        {
            ...
            var resultObject = new BooleanResult
            {
                ...
                Value = false,
                PropertyName = "IsReadOnly",
                TargetAutomationId = "nonExistentElement",
                // WindowTitle not available in ElementSearchResult,
                Pattern = "ValuePattern",
                Method = "IsReadOnlyAsync",
            ...
            _mockValueService.Setup(s => s.IsReadOnlyAsync("nonExistentElement", "TestWindow", null, null, 30))
                                 .Returns(Task.FromResult(serverResponse));
        ...
        public async Task IsElementReadOnly_ValuePatternNotSupported_ReturnsError()
        {
            ...
            var resultObject = new BooleanResult
            {
                ...
                Value = false,
                PropertyName = "IsReadOnly",
                TargetAutomationId = "unsupportedElement",
                // WindowTitle not available in ElementSearchResult,
                Pattern = "ValuePattern",
                Method = "IsReadOnlyAsync",
            ...
            _mockValueService.Setup(s => s.IsReadOnlyAsync("unsupportedElement", "TestWindow", null, null, 30))
                                 .Returns(Task.FromResult(serverResponse));
        ...
        public async Task IsElementReadOnly_WithCustomTimeout_Success()
        {
            ...
            var resultObject = new BooleanResult
            {
                ...
                Value = false,
                PropertyName = "IsReadOnly",
                TargetAutomationId = "editableTextBox",
                // WindowTitle not available in ElementSearchResult,
                Pattern = "ValuePattern",
                Method = "IsReadOnlyAsync",
            ...
            _mockValueService.Setup(s => s.IsReadOnlyAsync("editableTextBox", "TestWindow", null, null, 60))
                                 .Returns(Task.FromResult(serverResponse));
        ...
        public async Task ScrollElement_Success_ScrollsElement()
        {
            ...
            var resultObject = new ActionResult
            {
                ...
                TargetAutomationId = "scrollableList",
                // WindowTitle not available in ElementSearchResult,
                Completed = true,
                ErrorMessage = null
            };
        ...
        public async Task GetText_Success_GetsText()
        {
            ...
            {
                Success = true,
                TargetAutomationId = "textElement",
                // WindowTitle not available in ElementSearchResult,
        ...
        public async Task GetElementTree_Success_ReturnsElementTree()
        {
            ...
            {
                Success = true,
                RootNode = new TreeNode { Name = "TestWindow", TargetAutomationId = "root1" },
                TotalElements = 1
            };
        ...
        public async Task GetSelection_Success_ReturnsSelection()
        {
            ...
            var selectionResult = new SelectionInfoResult
            {
                ...
                {
                    new SelectionItem { TargetAutomationId = "item1", Name = "Item 1", IsSelected = true },
                    new SelectionItem { TargetAutomationId = "item2", Name = "Item 2", IsSelected = true }
                },
                SelectedCount = 2
            };
        ...
        public async Task GetTableInfo_WithValidParameters_CallsCorrectService()
        {
            ...
            {
                Success = true,
                TableTargetAutomationId = "table1",
                // WindowTitle not available in ElementSearchResult,
                RowCount = 5,
                ColumnCount = 3,
                HasRowHeaders = true,
        ...
        public async Task GetAvailableViews_WithValidParameters_CallsCorrectService()
        {
            ...
            var resultObject = new ElementSearchResult
            {
                ...
                Elements = new List<UIAutomationMCP.Shared.ElementInfo>
                {
                    new UIAutomationMCP.Shared.ElementInfo
                    {
                        TargetAutomationId = "viewContainer1",
                        Name = "View Container",
                        ControlType = "List"
                    }
                },
        ...
        public async Task ScrollElement_WithCustomAmount_ShouldCallService()
        {
            ...
            var resultObject = new ActionResult
            {
                Success = true,
                Action = "ScrollElement",
                TargetAutomationId = "scrollable1",
                Completed = true,
                ErrorMessage = null
            };
            var serverResponse = new ServerEnhancedResponse<ActionResult>
        ...
        public async Task GetScrollInfo_Should_Call_LayoutService_With_Correct_Parameters()
        {
            ...
            {
                Success = true,
                TargetAutomationId = "scrollableElement",
                // WindowTitle not available in ElementSearchResult,
        ...
        public async Task SetScrollPercent_Should_Call_LayoutService_With_Valid_Percentages()
        {
            ...
            var resultObject = new ActionResult
            {
                ...
                TargetAutomationId = "scrollContainer"
            };
            var serverResponse = new ServerEnhancedResponse<ActionResult>
            {
                Success = true,
        ...
        public async Task SetScrollPercent_Should_Handle_NoScroll_Values()
        {
            ...
            var resultObject = new ActionResult
            {
                Success = true,
                ActionName = "SetScrollPercent",
                TargetAutomationId = "scrollElement"
            };
            var serverResponse = new ServerEnhancedResponse<ActionResult>
            {
                Success = true,
        ...
        public async Task SetScrollPercent_Should_Accept_Valid_Range_Values(double horizontal, double vertical)
        {
            ...
            var resultObject = new ActionResult
            {
                Success = true,
                ActionName = "SetScrollPercent",
                TargetAutomationId = "testElement"
            };
            var serverResponse = new ServerEnhancedResponse<ActionResult>
            {
                Success = true,
        ...
        public async Task ScrollElementIntoView_Should_Handle_Custom_Timeout()
        {
            ...
            var resultObject = new ActionResult
            {
                Success = true,
                Action = "ScrollElementIntoView",
                TargetAutomationId = "slowElement",
                WindowTitle = "TestWindow",
                Completed = true,
                ErrorMessage = null
            };
        ...
        public async Task GetColumnHeader_Should_Call_TableService_With_Correct_Parameters()
        {
            ...
            var resultObject = new ElementSearchResult
            {
                ...
                Elements = new List<ElementInfo>
                {
                    new ElementInfo
                    {
                        TargetAutomationId = "header_col1",
                        Name = "Name",
                        ControlType = "Header",
                        IsEnabled = true,
                    ...
                    new ElementInfo
                    {
                        TargetAutomationId = "header_col2",
                        Name = "Age",
                        ControlType = "Header",
                        IsEnabled = true,
        ...
        public async Task GetRowHeader_Should_Call_TableService_With_Correct_Parameters()
        {
            ...
            var resultObject = new ElementSearchResult
            {
                ...
                Elements = new List<ElementInfo>
                {
                    new ElementInfo
                    {
                        TargetAutomationId = "header_row1",
                        Name = "Person 1",
                        ControlType = "Header",
                        IsEnabled = true,
                    ...
                    new ElementInfo
                    {
                        TargetAutomationId = "header_row2",
                        Name = "Person 2",
                        ControlType = "Header",
                        IsEnabled = true,
        ...
        public async Task GetRowHeader_Should_Work_With_ProcessId_And_CustomTimeout()
        {
            ...
            var resultObject = new ElementSearchResult
            {
                ...
                Elements = new List<ElementInfo>
                {
                    new ElementInfo
                    {
                        TargetAutomationId = "row_header_special",
