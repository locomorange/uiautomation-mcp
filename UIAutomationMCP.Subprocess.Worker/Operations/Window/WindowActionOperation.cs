...
namespace UIAutomationMCP.Subprocess.Worker.Operations.Window
{
    public class WindowActionOperation : BaseUIAutomationOperation<WindowActionRequest, WindowActionResult>
    {
        ...
        protected override UIAutomationMCP.Core.Validation.ValidationResult ValidateRequest(WindowActionRequest request)
        {
            if (string.IsNullOrWhiteSpace(request.Action))
            {
                return UIAutomationMCP.Core.Validation.ValidationResult.Failure("Action is required");
            }
            ...
            {
                return UIAutomationMCP.Core.Validation.ValidationResult.Failure($"Invalid action '{request.Action}'. Valid actions are: {string.Join(", ", validActions)}");
            }
