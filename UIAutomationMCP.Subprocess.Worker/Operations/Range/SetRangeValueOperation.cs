...
namespace UIAutomationMCP.Subprocess.Worker.Operations.Range
{
    public class SetRangeValueOperation : BaseUIAutomationOperation<SetRangeValueRequest, SetRangeValueResult>
    {
        ...
        protected override UIAutomationMCP.Core.Validation.ValidationResult ValidateRequest(SetRangeValueRequest request)
        {
