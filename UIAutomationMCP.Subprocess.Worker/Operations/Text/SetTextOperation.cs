...
namespace UIAutomationMCP.Subprocess.Worker.Operations.Text
{
    public class SetTextOperation : BaseUIAutomationOperation<SetTextRequest, SetValueResult>
    {
        ...
        protected override UIAutomationMCP.Core.Validation.ValidationResult ValidateRequest(SetTextRequest request)
        {
            ...
            {
                return UIAutomationMCP.Core.Validation.ValidationResult.Failure("Text cannot be null");
            }
