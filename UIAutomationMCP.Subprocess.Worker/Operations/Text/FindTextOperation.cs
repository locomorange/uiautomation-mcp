...
namespace UIAutomationMCP.Subprocess.Worker.Operations.Text
{
    public class FindTextOperation : BaseUIAutomationOperation<FindTextRequest, TextSearchResult>
    {
        ...
        protected override UIAutomationMCP.Core.Validation.ValidationResult ValidateRequest(FindTextRequest request)
        {
            if (string.IsNullOrEmpty(request.SearchText))
            {
                return UIAutomationMCP.Core.Validation.ValidationResult.Failure("SearchText is required");
            }
