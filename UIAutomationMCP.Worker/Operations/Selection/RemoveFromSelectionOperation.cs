...
namespace UIAutomationMCP.Worker.Operations.Selection
{
    public class RemoveFromSelectionOperation : IUIAutomationOperation
    {
        ...
        public RemoveFromSelectionOperation(ElementFinderService elementFinderService)
        {
        ...
        public Task<OperationResult> ExecuteAsync(WorkerRequest request)
        {
            ...
            return Task.FromResult(new OperationResult { Success = true, Data = "Element removed from selection successfully" });
        }
    }
}
