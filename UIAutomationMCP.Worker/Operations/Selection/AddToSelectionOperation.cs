...
namespace UIAutomationMCP.Worker.Operations.Selection
{
    public class AddToSelectionOperation : BaseUIAutomationOperation<AddToSelectionRequest, SelectionActionResult>
    {
        ...
        {
            // 繝代ち繝ｼ繝ｳ螟画鋤・医Μ繧ｯ繧ｨ繧ｹ繝医°繧牙叙蠕励√ョ繝輔か繝ｫ繝医・SelectionItemPattern・・            var requiredPattern = AutomationPatternHelper.GetAutomationPattern(request.RequiredPattern) ?? SelectionItemPattern.Pattern;
