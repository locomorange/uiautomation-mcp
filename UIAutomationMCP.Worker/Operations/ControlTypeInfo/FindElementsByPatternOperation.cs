    ...
    public class FindElementsByPatternOperation : IUIAutomationOperation
    {
        ...
        public Task<OperationResult> ExecuteAsync(string parametersJson)
        {
            try
            {
                ...
                TreeScope treeScope = (typedRequest.Scope ?? "descendants").ToLower() switch
                {
                ...
                var maxResults = 100; // Default value
                var timeoutMs = typedRequest.TimeoutSeconds * 1000;
                    ...
                    while (child != null && results.Count < maxResults)
                    {
                        ...
                        else
                        {
                            ...
                            SearchForPattern(child, walker, patternId, TreeScope.Subtree, results, 
                                validateAvailability, maxResults);
                        }
