...
namespace UIAutomationMCP.Models.Serialization
{
    ...
    // Pattern Properties
    [JsonSerializable(typeof(PatternProperties))]
    [JsonSerializable(typeof(ValuePatternProperties))]
    [JsonSerializable(typeof(RangeValuePatternProperties))]
    [JsonSerializable(typeof(TogglePatternProperties))]
    [JsonSerializable(typeof(SelectionPatternProperties))]
    [JsonSerializable(typeof(GridPatternProperties))]
    [JsonSerializable(typeof(WindowPatternProperties))]
    [JsonSerializable(typeof(TransformPatternProperties))]
    [JsonSerializable(typeof(TypedPatternInfo))]
    // Service Metadata
    [JsonSerializable(typeof(ServiceMetadata))]
    ...
    [JsonSerializable(typeof(SelectionServiceMetadata))]
    [JsonSerializable(typeof(SynchronizedInputServiceMetadata))]
    [JsonSerializable(typeof(TableServiceMetadata))]
    [JsonSerializable(typeof(TextServiceMetadata))]
    [JsonSerializable(typeof(ToggleServiceMetadata))]
    [JsonSerializable(typeof(TransformServiceMetadata))]
    [JsonSerializable(typeof(ValueServiceMetadata))]
    [JsonSerializable(typeof(VirtualizedItemServiceMetadata))]
    [JsonSerializable(typeof(WindowServiceMetadata))]
    [JsonSerializable(typeof(TreeNavigationServiceMetadata))]
    [JsonSerializable(typeof(ScreenshotServiceMetadata))]
    [JsonSerializable(typeof(FocusServiceMetadata))]
    [JsonSerializable(typeof(EventMonitorServiceMetadata))]
    [JsonSerializable(typeof(ApplicationLauncherMetadata))]
    // Additional Server result types
