...
namespace UIAutomationMCP.Server.Services.ControlPatterns
{
    ...
    {
        Task<ServerEnhancedResponse<ActionResult>> SelectItemAsync(string? automationId = null, string? name = null, string? controlType = null, long? windowHandle = null, int timeoutSeconds = 30);
