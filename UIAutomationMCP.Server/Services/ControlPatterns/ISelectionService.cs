...
namespace UIAutomationMCP.Server.Services.ControlPatterns
{
    public interface ISelectionService
    {
        ...
        Task<ServerEnhancedResponse<SelectionInfoResult>> GetSelectionContainerAsync(string elementId, string? windowTitle = null, int? processId = null, int timeoutSeconds = 30);
    }
}
