...
namespace UIAutomationMCP.Server.Services.ControlPatterns
{
    public class ToggleService : IToggleService
    {
        ...
        public async Task<ServerEnhancedResponse<ToggleStateResult>> GetToggleStateAsync(string elementId, string? windowTitle = null, int? processId = null, int timeoutSeconds = 30)
        {
            var stopwatch = Stopwatch.StartNew();
            var operationId = Guid.NewGuid().ToString("N")[..8];
